...
#define ENET1_RSET IMX_GPIO_NR(5, 7) 
#define ENET2_RSET IMX_GPIO_NR(5, 8) 
...
static void setup_iomux_fec(int fec_id)
{
	if (fec_id == 0)
	{
		...
		gpio_direction_output(ENET1_RSET, 1);
		gpio_set_value(ENET1_RSET, 0);
		mdelay(20);
		gpio_set_value(ENET1_RSET, 1);
	}
	else
	{
		imx_iomux_v3_setup_multiple_pads(fec2_pads,
						 ARRAY_SIZE(fec2_pads));
		gpio_direction_output(ENET2_RSET, 1);
		gpio_set_value(ENET2_RSET, 0);
		mdelay(20);
		gpio_set_value(ENET2_RSET, 1);
	}
}
